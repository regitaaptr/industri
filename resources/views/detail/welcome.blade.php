...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <nav class="navbar fixed-stop navbar-expand-lg navbar-light " style="background-color:rgb(213, 217, 219);">
            <div class="container">
                    ...
                    @foreach ($berita as $data)
                        <div class="col-3 md-3">
                            <div class="card" style="width: 15rem;">
                                <img src="{{asset('images/berita/' . $data->cover )}}" class="card-img-top" alt="...">
                                <div class="card-body">
    ...
    <footer class="mt-5" height="70%" style="background-color:rgb(74, 81, 84);" >
        <div class="row text-white p-5">
            <div class="text-center text-white font-weight-bold">
                <p>Made By <a href="https://www.instagram.com/rgtaaoktaa/">Regita</a></p>
            </div>     
        </div>
      </footer>
    </body>
